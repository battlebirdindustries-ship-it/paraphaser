...
export default function PhaserLogo({ size = 32, color = "#00ffc8", firing = false }: { size?: number; color?: string; firing?: boolean }) {
  const id = useId();
  return (
    <svg width={size * 1.4} height={size} viewBox="0 0 45 32" fill="none" aria-label="paraphaser.ai logo">
      <defs>
      ...
      <line x1="21" y1="28" x2="27" y2="28" stroke={color} strokeWidth="0.4" opacity="0.3" />
